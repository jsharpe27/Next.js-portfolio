...
export default function Project({title, description, tags, imageUrl}: ProjectProps){
    ...
    return (
            <motion.div
                ...
                className=' group mb-3 sm:mb-8 last:mb-0' //We use the group class to control the hover effect on the project component, and to control even or odd projects
            >
                <section 
                className=' group bg-gray-100 max-w-[42rem] border
                border-black/5 overflow-hidden sm:pr-8 
                relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 even:pl-8
